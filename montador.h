...
// void montador_uma_passagem(char const *source_file, char const *output_file);
//
//
// void montador_uma_passagem(char const *source_file, char const *output_file){
//
...
//
//     assemble_symble_table_t *name_symble = NULL;
//
...
//
//     if ( source_ptr == NULL ){
//         printf(" n Houve um erro ao abrir o arquivo %s ! n", source_file);
//         exit(1);
//     }
//
//     if ( output_ptr == NULL ){
//         printf(" n Houve um erro ao criar o arquivo %s ! n", output_file);
//         exit(1);
//     }
//
//     if ( binary_ptr == NULL ){
//         printf(" n Houve um erro ao criar o arquivo temporário!  n");
//         exit(1);
//     }
//
